...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 21, 2020 at 05:27 PM
...
INSERT INTO `mastertabelbiaya` (`id_biaya`, `jenis_biaya`, `nominal`) VALUES
(1, 'iuran bulanan', 150000),
(2, 'tabungan', 20000),
(8, 'Kas', 5000),
(9, 'Piknik', 30000);
...
INSERT INTO `pengajar` (`id_pengajar`, `NIP`, `id_kelas`, `id_mapel`) VALUES
(6, '000000000000002', 1, 2);
...
INSERT INTO `siswa` (`NIS`, `nama_siswa`, `TTL`, `jenis_kelamin`, `alamat`, `status_siswa`) VALUES
('123337', 'Ayaya', 'Medan, 5 Januari 2000', 'P', 'mangkang', 'Keluar'),
('123456', 'Defina YT', 'Kab. Semarang, 20 Agustus 2003', 'P', 'Kota Magelang', 'Aktif'),
('655554', 'Mufid', 'Semarang,  Desember 1999', 'L', 'mangkang', 'Lulus');
...
INSERT INTO `tanggal` (`id_tanggal`) VALUES
(1),
(2),
(3),
(4),
...
--
ALTER TABLE `absensi`
  ADD PRIMARY KEY (`NIS`,`id_tanggal`,`id_tahun`,`id_semester`),
...
--
ALTER TABLE `spp`
  ADD PRIMARY KEY (`NIS`,`id_bulan`,`id_tahun`,`tanggal_bayar`),
  ADD KEY `NIP` (`NIP`),
...
--
ALTER TABLE `tanggal`
  MODIFY `id_tanggal` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
...
ALTER TABLE `absensi`
  ...
  ADD CONSTRAINT `absensi_ibfk_2` FOREIGN KEY (`id_tanggal`) REFERENCES `tanggal` (`id_tanggal`),
  ADD CONSTRAINT `absensi_ibfk_3` FOREIGN KEY (`id_tahun`) REFERENCES `tahun_ajaran` (`id_tahun`),
  ADD CONSTRAINT `absensi_ibfk_4` FOREIGN KEY (`NIS`) REFERENCES `siswa` (`NIS`),
  ADD CONSTRAINT `absensi_ibfk_5` FOREIGN KEY (`id_tahun`) REFERENCES `tahun_ajaran` (`id_tahun`),
  ADD CONSTRAINT `absensi_ibfk_6` FOREIGN KEY (`NIS`) REFERENCES `siswa` (`NIS`);
