...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 28, 2020 at 10:52 AM
...
CREATE TABLE `absensi` (
  ...
  `id_master_semester` int(10) NOT NULL,
...
INSERT INTO `absensi` (`id_absensi`, `NIS`, `id_master_semester`, `tanggal_presensi`, `presensi`) VALUES
(204, '0028609553', 3, '2020-06-28', 'Hadir'),
(205, '0033084998', 3, '2020-06-28', 'Hadir'),
(206, '0034100746', 3, '2020-06-28', 'Hadir'),
(207, '0034548870', 3, '2020-06-28', 'Hadir'),
(208, '0037175292', 3, '2020-06-28', 'Hadir'),
(209, '0037526928', 3, '2020-06-28', 'Hadir'),
(210, '0041405333', 3, '2020-06-28', 'Hadir'),
(211, '0042621053', 3, '2020-06-28', 'Hadir'),
(212, '0043404994', 3, '2020-06-28', 'Sakit'),
(213, '0051742716', 3, '2020-06-28', 'Hadir'),
(214, '0028609553', 3, '2020-06-24', 'Ijin'),
(215, '0033084998', 3, '2020-06-24', 'Hadir'),
(216, '0034100746', 3, '2020-06-24', 'Hadir'),
(217, '0034548870', 3, '2020-06-24', 'Hadir'),
(218, '0037175292', 3, '2020-06-24', 'Hadir'),
(219, '0037526928', 3, '2020-06-24', 'Hadir'),
(220, '0041405333', 3, '2020-06-24', 'Hadir'),
(221, '0042621053', 3, '2020-06-24', 'Hadir'),
(222, '0043404994', 3, '2020-06-24', 'Hadir'),
(223, '0051742716', 3, '2020-06-24', 'Hadir');
...
(12, 'Sumbangan Pembinaan Pendidikan 2019', 220000, 2019);
...
INSERT INTO `master_semester` (`id_master_semester`, `nama_semester`, `id_tahun`, `id_semester`, `tanggal_mulai`, `tanggal_akhir`) VALUES
(2, 'Ganjil 2019/2020', 1, 1, '2019-08-05', '2019-12-13'),
(3, 'Genap 2019/2020', 1, 2, '2020-01-06', '2020-06-28');
...
('000000000000004', 'Admin', 'Kota Semarang', 'admin@admin.com', '25d55ad283aa400af464c76d713c07ad', 'Aktif', 'logo-user.png', 1),
...
(204, '196307131987012001'),
(205, '196307131987012001'),
(206, '196307131987012001'),
(207, '196307131987012001'),
(208, '196307131987012001'),
(209, '196307131987012001'),
(210, '196307131987012001'),
(211, '196307131987012001'),
(212, '196307131987012001'),
(213, '196307131987012001'),
(214, '196307131987012001'),
(215, '196307131987012001'),
(216, '196307131987012001'),
(217, '196307131987012001'),
(218, '196307131987012001'),
(219, '196307131987012001'),
(220, '196307131987012001'),
(221, '196307131987012001'),
(222, '196307131987012001'),
(223, '196307131987012001');
...
('1234455', 'Defina', 2019, 'Kebumen', '2016-10-12', 'P', 'Jalan S. Parman Gang Kenangasari III Nomor 13', 'siswa_P.png', 'Aktif'),
...
(1, '0018876719', 1, 1, '2020-06-03', '196307131987012001', 'Lunas', 200000, 0, 200000, '-'),
(2, '0018876719', 2, 1, '2020-06-03', '196307131987012001', 'Lunas', 200000, 0, 200000, '-'),
(3, '0018876719', 3, 1, '2020-06-03', '196307131987012001', 'Lunas', 200000, 0, 200000, '-'),
(4, '0032114298', 1, 1, '2020-06-11', '111111111111125', 'Lunas', 170000, 0, 170000, '-'),
(5, '0032114298', 2, 1, '2020-06-11', '111111111111125', 'Lunas', 170000, 0, 170000, '-'),
(6, '0032114298', 3, 1, '2020-06-11', '111111111111125', 'Lunas', 170000, 150000, 20000, 'Djarum'),
(7, '0032114298', 4, 1, '2020-06-11', '111111111111125', 'Lunas', 170000, 150000, 20000, 'Djarum'),
(10, '0018876719', 4, 1, '2020-06-12', '000000000000004', 'Lunas', 200000, 150000, 50000, 'Djarum'),
(11, '0018876719', 6, 1, '2020-06-12', '196307131987012001', 'Lunas', 220000, 150000, 70000, 'Djarum');
...
ALTER TABLE `absensi`
  ...
  ADD KEY `NIS` (`NIS`),
  ADD KEY `id_master_semester` (`id_master_semester`);
...
ALTER TABLE `master_semester`
  ADD PRIMARY KEY (`id_master_semester`),
...
--
ALTER TABLE `absensi`
  MODIFY `id_absensi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=224;
...
--
ALTER TABLE `mastertabelbiaya`
  MODIFY `id_biaya` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `master_semester`
--
ALTER TABLE `master_semester`
  MODIFY `id_master_semester` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `wali_kelas`
  MODIFY `id_wali_kelas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=89;
...
ALTER TABLE `absensi`
  ...
  ADD CONSTRAINT `absensi_ibfk_2` FOREIGN KEY (`id_master_semester`) REFERENCES `master_semester` (`id_master_semester`);
...
--
-- Constraints for table `master_semester`
--
ALTER TABLE `master_semester`
  ADD CONSTRAINT `master_semester_ibfk_1` FOREIGN KEY (`id_semester`) REFERENCES `semester` (`id_semester`),
  ADD CONSTRAINT `master_semester_ibfk_2` FOREIGN KEY (`id_tahun`) REFERENCES `tahun_ajaran` (`id_tahun`);
